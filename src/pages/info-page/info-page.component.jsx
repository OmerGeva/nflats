                    ...
                    <div className="terms-info">
                        ...
                        <ol>
                            <li>
                                ...
                                <p><a href='nflats.net'>nflats.net</a> provides the Website, the Content, and the Services to you subject to the following Terms of Service (“TOS”). The TOS may be updated by us from time to time without notice to you. We suggest that from time to time you review the TOS for possible changes. In addition, when using any Services or accessing any Content, you will be subject to any posted guidelines or rules applicable to such Services or Content. All such additional guidelines or rules are hereby incorporated by reference into the TOS.</p>
                            </li>
                            <li>
                                <p>SERVICES AND CONTENT</p>
                                <p><a href='nflats.net'>nflats.net</a> currently provides users with various features and services, including handicapper picks, and other features, all of which may be updated, deleted, or otherwise modified from time to time at the discretion of nflats.net. In addition, nflats.net provides access to certain photographs, text, images, statistics, logos, and other media and intellectual property related to or otherwise associated with nflats.net. Unless stated otherwise, the Website, the Services, and the Content are subject to the TOS. You understand and agree that the Website, the Services, and the Content are provided “AS IS” and that nflats.net assume no responsibility in connection with your use of the Website, the Services, or the Content. The Website, the Services, and the Content are provided for your non-commercial entertainment and enjoyment.The Company does not offer bookmaking services or gambling services on the Site or otherwise. The Company does not provide investment advice and none of the Picks nor any information on the Site or otherwise should be construed as or, deemed to be, investment advice. Under the TOS, you may download certain Content and Services available on the Website to a single personal computing device for your use and entertainment. However, you may not distribute, modify, republish, or publicly display any of the Content or Services unless you have the prior written permission of nflats.net, which permission may be withheld at  nflats.net’s sole discretion.</p>
                            </li>
                            <li>
                                <p>BACKGROUND INFORMATION</p>
                                <p>In order to use the Services, you may be required to register with nflats.net by providing certain information about yourself, including your name and email address. In consideration of your use of the Services, you agree to provide true, accurate, current and complete information about yourself as requested in connection with the provision of and/or registration for any of the Services, subject, of course, to all applicable laws. If you provide any information that is untrue, inaccurate, not current, or incomplete, or nflats.net has reasonable grounds to suspect that such information is untrue, inaccurate, not current, or incomplete, nflats.net has the right to suspend or terminate your password and/or refuse any and all current or future use of the Services.</p>
                            </li>
                            <li>
                                <p>PRIVACY POLICY</p>
                            ...
                            <li>
                                <p> REFUND POLICY</p>
                                <p>Due to the nature of the information being provided, all refund requests will be assessed on a case-by-case basis. All inquiries should be sent to <a href="mailto:support@nflats.net">support@nflats.net</a> where you will receive a response within 24 hours.</p>
                            </li>
                        </ol>
                        <p>If you have any questions or comments about our use of personal information, please contact us at:</p>
                        <p><a href="mailto:support@nflats.net">support@nflats.net</a></p>
                    </div>
                    :
                    <div className="privacy-policy">
                        <p>
                        This privacy notice discloses the privacy practices for nflats.net. This privacy notice applies solely to information collected by this website. It will notify you of the following:
                        </p>
                        <p>
                            Your use of the Website, the Content, and the Services is also subject to all applicable laws and regulations. If you do not agree to any of the terms of service in this agreement, you should not use the Website, the Services, or the Content. Your use of the Website, the Content, and the Services is also governed by our Privacy Policy, which is available through a link on our homepage as well as most of the other pages on the website.
                        </p>
